...
#cp ${DeployDir}/${sfProjectName}/config/${Mode}.propel.ini ${DeployDir}/${sfProjectName}/config/propel.ini
...
#php ${DeployDir}/scrumdog/consolidator.php #Don't want this in dev mode
